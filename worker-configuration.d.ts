/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 84ccfd614d9f51b819feff511ac27ef6)
...
interface __BaseEnv_Env {
	...
	DATABASE_URL: string;
	BUCKET0_API_KEY: string;
	BUCKET0_S3_ACCESS_KEY_ID: string;
	BUCKET0_S3_SECRET_ACCESS_KEY: string;
	BUCKET0_S3_BUCKET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_USERNAME" | "ADMIN_PASSWORD" | "DATABASE_URL" | "BUCKET0_API_KEY" | "BUCKET0_S3_ACCESS_KEY_ID" | "BUCKET0_S3_SECRET_ACCESS_KEY" | "BUCKET0_S3_BUCKET">> {}
}
